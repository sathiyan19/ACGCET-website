      ...
      <div className="recin">
        <div className="rectext">
          ...
          <div className="recparasec">
            ...
            <p className="recpara">
              Experience our College's Top Recruiters Section, where excellence
              meets opportunity. Explore the remarkable collaborations we've
              fostered with leading companies, enabling our students to embark
              on successful journeys and impactful careers in diverse fields."
            </p>
