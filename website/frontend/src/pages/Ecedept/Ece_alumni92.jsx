...
import './Ece_alumni92.css'

import { Backtotop,Floatinmenu, Underline} from "../../widgets";
import {Profile_display} from '../../components'
import { ece_dept_menu,ece_alumni92} from "../../constants/ece_dept";
          ...
          <section className="ecedark">
            ...
            <div className="ece_rankers_area">
                <div className='ece_rankers'>
                    <Underline heading="1992-1996 Batch"/>
                    {ece_alumni92.map((item)=>
