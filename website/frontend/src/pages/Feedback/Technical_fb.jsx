...
const Technical_fb = () => {
  return (
    ...
    <div className="technical_fb_form">
    <div className="technical_fb_rows">

        <input type="text" className ="technical_fb_input" placeholder='Programme'  required/>
            <input type="text"  className ="technical_fb_input" placeholder='Semester'  required/>
    </div>
    <div className="technical_fb_rows">
     <input type="text" className='technical_fb_input_full' placeholder='Course Title' required />

    </div>

    <div className="technical_fb_rows">
        <input type="text" className='technical_fb_input' placeholder='Course code' />
        <input type="text" className='technical_fb_input' placeholder='Faculty' />
        
    </div>

    <div className="technical_fb_rows">
        <input type="text" className='technical_fb_input_full'  placeholder=' Student E-mail Address' required/>
    </div>
